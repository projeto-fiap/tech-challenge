...
public class AuthControllerTest {
    ...
    public void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(authController).build();  // Configura o MockMvc sem Spring Context
    }
    ...
    public void testLoginSuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/auth/login")
                ...
                .andExpect(MockMvcResultMatchers.content().string(token));  // Espera que o conteúdo da resposta seja o token gerado
    }
    ...
    public void testLoginInvalidCredentials() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/auth/login")
                        ...
                        .param("password", password)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isUnauthorized())  // Espera status 401 Unauthorized
                .andExpect(MockMvcResultMatchers.content().string("Invalid credentials"));  // Espera que o conteúdo seja "Invalid credentials"
    }
    ...
    public void testLoginBadRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/auth/login")
                        ...
                        .param("password", password)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())  // Espera status 400 Bad Request
                .andExpect(MockMvcResultMatchers.content().string("Bad request: Bad request"));  // Espera que o conteúdo seja "Bad request"
    }
}
