...
// assertTrue(objectMapper.getRegisteredModuleIds().contains(new
// JavaTimeModule().getTypeId()));
...
// HttpMessageConverter<BufferedImage> converter =
// configuration.bufferedImageHttpMessageConverter();
//
// assertNotNull(converter);
// assertTrue(converter instanceof BufferedImageHttpMessageConverter);
// assertEquals(MediaType.IMAGE_PNG, ((BufferedImageHttpMessageConverter)
// converter).getDefaultContentType());
// }
//
// @Test
// void testInitializePersonUseCase() {
// PersonDataProvider personDataProvider = mock(PersonDataProvider.class);
// InitializePersonUseCaseImpl useCase =
// configuration.initializePersonUseCase(personDataProvider);
//
...
// PersonDataProvider personDataProvider = mock(PersonDataProvider.class);
// RetrievePersonUseCaseImpl useCase =
// configuration.retrievePersonUseCase(personDataProvider);
//
// assertNotNull(useCase);
// }
//
...
// PersonDataProvider personDataProvider = mock(PersonDataProvider.class);
// UpdatePersonUseCaseImpl useCase =
// configuration.updatePersonUseCase(personDataProvider);
//
// assertNotNull(useCase);
// }
//
...
// PersonDataProvider personDataProvider = mock(PersonDataProvider.class);
// DeletePersonUseCaseImpl useCase =
// configuration.deletePersonUseCase(personDataProvider);
//
// assertNotNull(useCase);
// }
//
